...
namespace Tourist_Attraction.Controllers
{
    public class HomeController : Controller
    {
      ...
      "https://img.wongnai.com/p/1600x0/2019/07/02/bd1d256256c14c208d0843a345f75741.jpg"} ,
                    Tags = new List<string> {"เกาะ", "ทะเล", "จุดชมวิว", "ธรรมชาติ", "ตราด"} ,
                },
                new Trip {
      ...
      "https://img.wongnai.com/p/1600x0/2020/02/18/68289e188ea54e00b5e9d806cfd0fc54.jpg"} ,
                    Tags = new List<string> {"คาเฟ่","ร้านกาแฟ","จุดถ่ายรูป","เที่ยวใกล้กรุง","กรุงเทพมหานคร"} ,
                },
                new Trip {
                    ...
                    Description = "บานสะพรั่งแล้วจ้า กับทุ่งทานตะวันที่ใหญ่กว่า 30 ไร่ แต่อย่าชะล่าใจไป เพราะว่าเปิดให้เข้าชมถึงแค่เดือนมกราคมเท่านั้น งั้นอย่าช้าไปที่ ไร่คีรีบูรพา ชลบุรี",
      ...
      "https://img.wongnai.com/p/1600x0/2019/12/27/939f644df3d847409a85c1b2d054af25.jpg"},
                    Tags = new List<string> {"จุดถ่ายรูป", "ถ่ายรูปสวย", "เที่ยวใกล้กรุง", "ชลบุรี"}
                },
                new Trip {
      ...
      "https://img.wongnai.com/p/1600x0/2019/12/25/2974828fdb16492da0e8f35f627ade7a.jpg",},
                    Tags = new List<string> {"จุดถ่ายรูป","หมู่บ้าน","ภูเขา","ธรรมชาติ","ถ่ายรูปสวย","บ้านอีต่องเหมืองปิล็อก","กาญจนบุรี",}
                },
                new Trip {
                    Title = "ทริปที่เที่ยวและร้านกาแฟเชียงใหม่ ที่สวยได้แบบไม่ต้องไปไกลถึงเกาหลี",
                    Eid = "5",
                    Url = "https://www.wongnai.com/trips/attraction-chiangmai-korea-style",
                    Description = "แวะคาเฟ่เชียงใหม่! เที่ยวสไตล์เกาหลีแบบไม่ต้องไปไกล หมุนตัวสูดรับอากาศบริสุทธิ์ท่ามกลางดอกหญ้าแห้ง อยู่ร้านกาแฟเชียงใหม่ให้เหมือนอยู่ในโซล",
      ...
      "https://img.wongnai.com/p/1600x0/2019/10/10/49c6a0f4c25a41b08b3ca47ce410195d.jpg",},
                    Tags = new List<string> {"จุดถ่ายรูป", "ถ่ายรูปสวย", "ร้านกาแฟ", "เชียงใหม่", "คาเฟ่"}
                },
                new Trip {
      ...
      "https://img.wongnai.com/p/1600x0/2019/07/31/58348f4c3ace47349e80e5930a7a525a.jpg",},
                    Tags = new List<string> {"ทะเล", "เกาะ", "สตูล", "ธรรมชาติ"}
                },
                new Trip {
      ...
      "https://img.wongnai.com/p/1920x0/2019/07/11/83cda5c3853443c4a1398fb3ae6b31a8.jpg",},
                    Tags = new List<string> {"จุดถ่ายรูป", "ต่างประเทศ", "ไต้หวัน", "ธรรมชาติ"}
                },
                new Trip {
      ...
      "https://img.wongnai.com/p/1600x0/2019/06/04/37b377e43f344da794cb3353aeca3fcf.jpg"},
                    Tags = new List<string> {"จุดถ่ายรูป", "ต่างประเทศ", "ญี่ปุ่น", "ธรรมชาติ", "ภูเขา"}
                },
                new Trip {
      ...
      "https://img.wongnai.com/p/1600x0/2019/05/23/7a677ee703ab448b9ca20c847aa74ce3.jpg",},
                    Tags = new List<string> {"จุดถ่ายรูป", "ต่างประเทศ", "ฝรั่งเศส"}
                },
                new Trip {
      ...
      "https://img.wongnai.com/p/1600x0/2019/05/21/ea0f93584b3c4f3ba0680fcc11bc3a13.jpg",},
                    Tags = new List<string> {"ต่างประเทศ", "ฟินแลนด์", "หิมะ", "ธรรมชาติ"}
                },
            };
